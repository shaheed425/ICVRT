...
export default function Hero({ setSearchQuery }) {
  ...
  return (
    <section
      ref={containerRef}
      className="relative min-h-[90vh] sm:min-h-screen w-full overflow-hidden flex flex-col justify-between bg-white pt-28 md:pt-36 z-10"
    >
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 grid lg:grid-cols-12 gap-12 lg:gap-16 items-center relative z-10 w-full mt-6 md:mt-10 flex-grow pb-12 lg:pb-16">
        ...
        <div
          ref={textGroupRef}
          className="lg:col-span-7 flex flex-col items-start text-left w-full max-w-full overflow-hidden relative z-10 pt-[40vh] sm:pt-0"
        >
          {/* Top category label */}
          ...
          {/* Description */}
          <p className="text-[13px] sm:text-sm text-slate-600 font-semibold leading-relaxed max-w-xl mb-6">
